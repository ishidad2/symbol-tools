export default {
  ja: {
    ...
    Index: {
      home: {
        placeholder: '例）dual-1.nodes-xym.work 「ドメイン名（FQDN）を入力してください。httpsや:3001ポート番号は入力しないでください',
    ...
    Harvest: {
      input: {
        ...
        node: '委任先のノードURL',
        node_placeholder: '例）dual-1.nodes-xym.work 「ドメイン名（FQDN）を入力してください。httpsや:3001ポート番号は入力しないでください」'
      },
      message: {
    ...
    Input: {
      search: {
        ...
        node_url: 'ノードURL',
        node_url_placeholder: '例）dual-1.nodes-xym.work 「ドメイン名（FQDN）を入力してください。httpsや:3001ポート番号は入力しないでください',
